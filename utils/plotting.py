...
kernel_to_label = {
    0.1:r"$\sigma_\mathrm{ker} = q_{1}$",
    1.5:r"$\sigma_\mathrm{ker} = q_{25}$",
    2.6:r"$\sigma_\mathrm{ker} = q_{50}$",
    3.6:r"$\sigma_\mathrm{ker} = q_{75}$",
    4.9:r"$\sigma_\mathrm{ker} = q_{99}$",
    9.8:r"$\sigma_\mathrm{ker} = 2q_{99}$"
}
